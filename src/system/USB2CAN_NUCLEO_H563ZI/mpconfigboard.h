#define MICROPY_HW_BOARD_NAME               "USB2CAN-NUCLEO_H563ZI"
...
#define MICROPY_HW_USB_CONFIGURATION_HS_STRING  "USB2CAN Config"
#define MICROPY_HW_USB_INTERFACE_HS_STRING      "USB2CAN Interface"
#define MICROPY_HW_USB_CONFIGURATION_FS_STRING  "USB2CAN Config"
#define MICROPY_HW_USB_INTERFACE_FS_STRING      "USB2CAN Interface"

#define MBOOT_USBD_MANUFACTURER_STRING "alelec"
#define MBOOT_USBD_PRODUCT_STRING      "USB2CAN Boot"

// boot.py performs filesystem setup, so don't auto-mount at startup.
